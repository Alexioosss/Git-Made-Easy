...
public class LessonSchemaMapper {
    ...
    public JpaLessonSchema toJpaSchema(Lesson lesson) {
        JpaLessonSchema schema =  new JpaLessonSchema(lesson.getTitle(), lesson.getDescription(),
    ...
    public Lesson fromJpaSchema(JpaLessonSchema schema) {
        return new Lesson(schema.getId(), schema.getTitle(), schema.getDescription(),
                schema.getDifficulty(), schema.getLessonOrder());
    }
    ...
    public Lesson fromFirebaseSchema(FirebaseLessonSchema schema) {
        Lesson lesson = new Lesson(schema.getId(), schema.getTitle(), schema.getDescription(),
                schema.getDifficulty(), schema.getLessonOrder());
