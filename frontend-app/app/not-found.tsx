...
export default function NotFound() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-4.5rem)]">
            ...
            after:h-[10px] after:bg-blue-500 after:blur-[10px] after:opacity-100 after:bg-black dark:after:bg-white">404</h1>
            <p className="text-lg text-gray-700 dark:text-gray-200 mt-2 text-center">
                <span className="animate-pulse">Oops...</span> looks like the page you're looking for doesn't exist.
                </p>
